...
export const CenterItemsN = styled.div`
  ${props => props.theme.flex.center};
`;

export const RubricsN = styled.div`
  ${props => props.theme.flex.center};
  flex-wrap: wrap;
  width: 100%;
  border-bottom: 1px solid #c8c8c8;
...
export const JudgeViewN = styled.div`
  border-radius: 6px;
  border: 1px solid #e8e8e8;
  padding: 20px;
  background-color: #f2f2f2;
...
export const ButtonGroupN = styled.div`
  a,
  button {
    width: 100%;
    display: block;
